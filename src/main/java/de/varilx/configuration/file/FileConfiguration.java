...
import de.varilx.configuration.MemoryConfiguration;
...
public abstract class FileConfiguration extends MemoryConfiguration {
     ...
     * {@link de.varilx.configuration.file.FileConfigurationOptions#getHeader()} instead.
     */
    @NotNull
    ...
    @NotNull
    @Override
    public de.varilx.configuration.file.FileConfigurationOptions options() {
        if (options == null) {
