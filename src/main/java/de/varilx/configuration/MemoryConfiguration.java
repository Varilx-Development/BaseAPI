...
import de.varilx.configuration.MemoryConfigurationOptions;
import de.varilx.configuration.MemorySection;
...
public class MemoryConfiguration extends MemorySection implements Configuration {
    ...
    protected de.varilx.configuration.MemoryConfigurationOptions options;
    ...
    @Override
    @NotNull
    public de.varilx.configuration.MemoryConfigurationOptions options() {
        if (options == null) {
