...
dependencies {
    ...
    implementation("org.hibernate.orm:hibernate-community-dialects:7.4.8.Final")
    testImplementation("org.hibernate.orm:hibernate-community-dialects:7.4.8.Final")
